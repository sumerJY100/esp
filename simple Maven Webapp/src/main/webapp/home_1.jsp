...
<script type="text/javascript" src="js/home/homeForSvg_1.js"></script>
<!-- DWR -->
<script type='text/javascript' src='/ESP/dwr/engine.js'></script>
<script type='text/javascript' src='/ESP/dwr/util.js'></script>
<script type='text/javascript' src='/ESP/dwr/interface/voltageAndCurrent.js'></script>
<style type="text/css">
.controllerForcer {
	font-size: 2;
	color: red;
