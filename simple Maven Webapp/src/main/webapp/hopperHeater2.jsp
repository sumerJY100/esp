...
<script type="text/javascript" src="js/heater/heaterSvgDynamic.js"></script>
<script type="text/javascript" src="js/hopperLevel/hopperHeaterForSvg2.js"></script>
...
<body>
	<center>
		...
		<div id="returnHeater2Jsp" style="top:50px;left:10px;" class="jumpBtn">瓷套瓷轴</div>
		<div id="hopperLevelSvgDiv" style="height:600px;"></div>
