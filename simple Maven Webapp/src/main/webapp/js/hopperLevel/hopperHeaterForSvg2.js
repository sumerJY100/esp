$(document).ready(
        function() {
            ...
            function drawRapperRunState(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, i) {
                ...
                // 阳极振打框
                drawRapperRunStateRect(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, -5, "灰 斗", i, "rightHopper");
                // 阳极振打方式
                drawRapperRunWay(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, -5, i, "rightHopper");
                // 阳极振打周期参数
                drawRapperRunParam(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, -5, i, "rightHopper");
                // 分割线
                drawSeperatorLine(svg, currentElectricFieldLocationX, currentElectricFieldLocationY);
                // 阴极振打框
                drawRapperRunStateRect(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, 65, "灰 斗", i, "leftHopper");
                // 阴极振打方式
                drawRapperRunWay(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, 65, i, "leftHopper");
                // 阴极振打周期参数
                drawRapperRunParam(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, 65, i, "leftHopper");
            }
            // 电场名称
            ...
            function drawRapperRunStateRect(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, rY, nameStr, locatoin, heaterTypeString) {
                ...
                $(porcelainShaftRect).attr("transform", "translate(0.5,0.5)").attr("id", rectSvgId);
            ...
            // 分割线
            function drawSeperatorLine(svg, currentElectricFieldLocationX, currentElectricFieldLocationY, heaterTypeString) {
