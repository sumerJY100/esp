...
<script type="text/javascript" src="js/heater/heaterForSvg2.js"></script>
...
<body>
	<center>
		...
		<div id="returnHeater3Jsp" style="top:50px;left:10px;" class="jumpBtn">灰斗加热</div>
		<div id="heaterSvgDiv" style="height:600px;"></div>
